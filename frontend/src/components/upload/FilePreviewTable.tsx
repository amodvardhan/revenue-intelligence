  ...
  return (
    <div className="overflow-hidden rounded-md border border-border bg-surface-elevated shadow-sm">
      <div className="border-b border-border px-4 py-3">
        <h2 className="text-heading text-base font-semibold text-slate-900">Preview (first 5 rows)</h2>
      </div>
      ...
      <div className="border-t border-border px-4 py-2 text-xs text-slate-500">
        {fileName}
